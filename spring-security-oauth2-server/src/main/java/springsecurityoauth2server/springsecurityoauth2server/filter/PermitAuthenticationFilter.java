package springsecurityoauth2server.springsecurityoauth2server.filter;
...
public class PermitAuthenticationFilter extends OAuth2AuthenticationProcessingFilter {
    ...
    public static final Logger log = LoggerFactory.getLogger(PermitAuthenticationFilter.class);
